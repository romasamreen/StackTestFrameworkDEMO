...
* Usage:
*
*  set your project's log4j.properties to include mars.Component.Functions.GroupedLoggingAppender as one of the logger
*
*  java -Doutputdir=/x/y/z/ org.testng.TestNG -reporter mars.Component.Functions.GroupedLoggingAppender your_testng.xml
*
*
...
*
* Set -Doutputdir=/x/y/z/ org.testng.TestNG -reporter mars.Component.Functions.GroupedLoggingAppender
...
public class GroupedLoggingAppender extends AppenderSkeleton implements IReporter {
   ...
   private String outputDir = "C:\\MARS_FRAMEWORK\\MARS_Automation_Framework_Tests\\log";
